...
const EmptyState = ({ onStartFirst }: EmptyStateProps) => {
  ...
  return (
    <div className='flex flex-col items-center justify-center sm:mx-auto p-6 sm:p-8 shadow-sm bg-white rounded-xl sm:rounded-2xl hover:shadow-md transition-shadow duration-200'>
      <img
        src={noExamHistory}
        alt='Empty quiz illustration'
        className='object-contain w-3/4 sm:w-1/2 h-auto mx-auto'
      />
