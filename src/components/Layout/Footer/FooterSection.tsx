...
const FooterSection = () => {
  ...
  return (
    <div className='text-white px-6 md:px-20 py-5 sm:py-20 relative flex md:justify-start justify-center md:items-start items-center md:text-start text-center bg-cover bg-no-repeat bg-center bg-[url(./assets/images/bg-footer.png)]'>
