...
const RecommendCard: React.FC<RecommendCardProps> = ({
  ...
  return (
    <Card className='relative bg-[#02185B] text-white my-3 rounded-3xl sm:mx-6 sm:p-4 lg:mx-4 lg:p-6 w-[20rem] md:w-[25rem] max-w-full sm:max-w-sm'>
      <div className='absolute top-20 sm:top-7 left-0 h-2/5 sm:h-4/5 w-1 bg-[#FE7743] rounded-r-full'></div>
