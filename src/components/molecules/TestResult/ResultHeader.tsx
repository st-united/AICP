  ...
  return (
    <div className='bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 lg:p-8 xl:p-10 space-y-6 lg:space-y-8'>
      ...
      <div className='text-center space-y-3 lg:space-y-4'>
        <h2 className='text-3xl sm:text-4xl md:text-[2.5rem] lg:leading-[2.6rem] xl:text-5xl font-bold bg-gradient-to-r from-[#FF872BCF] to-[#FF4D08] bg-clip-text text-transparent leading-tight px-2'>
