      ...
      <Row className='container mx-auto mt-16 !md:mt-0'>
        ...
        >
          <div className='flex flex-col md:flex-row items-center md:items-start gap-3 md:text-sm lg:text-lg mb-4'>
            <div className='bg-[#2F5371] rounded flex items-center justify-center text-center'>
              <MailOutlined className='text-4xl p-2 flex items-center justify-center text-center' />
            </div>
            <div>
        ...
        >
          <div className='flex flex-col md:flex-row items-center md:items-start gap-3 md:text-sm lg:text-lg'>
            <div className='bg-[#2F5371] rounded flex items-center justify-center text-center'>
              <EnvironmentOutlined className='text-4xl p-2 flex items-center justify-center text-center' />
            </div>
